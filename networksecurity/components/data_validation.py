...
class DataValidation:
    ...
    def is_numerical_column_exist(self,dataframe):
            try:
                ...
                numerical_colums=schema["numerical_columns"]
                missing_columns=[]
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            ##check numerical columns in train and test data
            status=self.is_numerical_column_exist(dataframe=train_dataframe)
            if not status:
                error_message=f"numerical column missing in train dataframe.\n"

            status=self.is_numerical_column_exist(dataframe=test_dataframe)
            if not status:
                error_message=f"numerical column missing in test dataframe.\n"    
